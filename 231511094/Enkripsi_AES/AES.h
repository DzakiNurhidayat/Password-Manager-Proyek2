/*Material (Mungkin nambah)*/
/*https://en.wikipedia.org/wiki/Rijndael_S-box*/      // Sumber SBOX dan INV_SBOX
/*https://en.wikipedia.org/wiki/Rijndael_MixColumns*/ // Sumber mul2&mul3
